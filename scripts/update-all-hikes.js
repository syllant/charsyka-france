...
/**
 * Update hiking trails for all cities
 */
async function updateAllCitiesHikes() {
  ...
  console.log(`🥾 Found ${cities.length} cities to update with hiking trail data:`);
  ...
  for (let i = 0; i < cities.length; i++) {
    ...
    try {
      await osmHikes.updateCityHikes(city.slug);
  ...
  // Show results
  console.log('\n🎉 All Cities Hiking Trails Update Complete!\n');
...
// Main execution
async function main() {
  console.log('🚀 Starting hiking trails update for all cities...');
  await updateAllCitiesHikes();
  console.log('\n✨ Process completed!');
}

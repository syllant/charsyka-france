...
/**
 * Update universities for all cities
 */
async function updateAllCitiesUniversities() {
  ...
  console.log(`🎓 Found ${cities.length} cities to update with university data:`);
  ...
  for (let i = 0; i < cities.length; i++) {
    ...
    try {
      await frEsrUniversities.updateCityUniversities(city.slug);
  ...
  // Show results
  console.log('\n🎉 All Cities Universities Update Complete!\n');
...
// Main execution
async function main() {
  console.log('🚀 Starting universities update for all cities...');
  await updateAllCitiesUniversities();
  console.log('\n✨ Process completed!');
}
